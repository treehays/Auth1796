...
namespace Auth1796.Infrastructure.Common.Logging.Serilog;
...
public static class Extensions
{
    public static void RegisterSerilog(this WebApplicationBuilder builder)
    {
        ...
        _ = builder.Host.UseSerilog((_, sp, serilogConfig) =>
        {
            ...
            string filePath = loggerSettings.FilePath;
            ...
            ConfigureWriteToFile(serilogConfig, writeToFile, filePath);
    ...
    private static void ConfigureWriteToFile(LoggerConfiguration serilogConfig, bool writeToFile, string filePath)
    {
        if (writeToFile)
        {
